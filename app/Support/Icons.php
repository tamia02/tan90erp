...
/**
 * Inline stroke paths for the Lucide icons referenced by nav item 'icon'
 * keys (RoleNavigation, Tan90ModuleNavigation, navigation.blade.php).
 * Hardcoded rather than depending on the lucide-static npm package at
 * runtime, since node_modules isn't deployed to production -- only the
 * compiled Vite assets are. Source: lucide-static (ISC license).
 */
class Icons
{
    private const PATHS = [
    ...
    public static function svg(string $name, string $class = 'w-5 h-5'): string
    {
        ...
        return '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="'.$class.'">'.$inner.'</svg>';
    }
}
