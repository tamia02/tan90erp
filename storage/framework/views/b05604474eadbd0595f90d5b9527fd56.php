...
<div class="max-w-3xl mx-auto">
    ...
    <div class="grid grid-cols-2 gap-3 mb-6">
        <div class="rounded-lg border p-4" style="background: var(--surface-3); border-color: var(--border);">
            ...
            <div class="text-2xl font-semibold mt-1" style="color: var(--text-primary);"><?php echo e($inQueue); ?></div>
        </div>
        <div class="rounded-lg border p-4" style="background: var(--surface-3); border-color: var(--border);">
            <div class="text-xs" style="color: var(--text-muted);">Completed Today</div>
            <div class="text-2xl font-semibold mt-1" style="color: var(--status-good);"><?php echo e($doneToday); ?></div>
        </div>
    </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $queue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="py-3 flex items-center justify-between gap-3">
                        <div>
                            ...
                            <div class="text-xs mt-0.5" style="color: var(--text-muted);"><?php echo e($g->material); ?> · <?php echo e($g->invoice_qty); ?> qty</div>
                        </div>
                        <a href="<?php echo e(route('qc.queue')); ?>" wire:navigate class="text-xs font-medium" style="color: var(--brand);">Check →</a>
                    </div>
...
</div><?php /**PATH C:\Users\tasmi\AppData\Local\Packages\5319275A.WhatsAppDesktop_cv1g1gvanyjgm\LocalState\sessions\C58B0E0E1F1E5561213D0701C5EBD37C2F6DB401\transfers\2026-28\tan90-mod1-current-code-20260708-103300\full_project\resources\views\livewire\qc\dashboard.blade.php ENDPATH**/ ?>