...
class DatabaseSeeder extends Seeder
{
    ...
    {
        SkuMaster::create([
            'sku' => 'PCM Raw Compound (TN-1 Grade)', 'category' => 'PCM — Raw Material', 'unit' => 'KG',
        ...
        SkuMaster::create([
            'sku' => 'Wire Mesh — Structural Packaging', 'category' => 'Packaging & Structural', 'unit' => 'NOS',
        ...
        SkuMaster::create([
            'sku' => 'Hand Gloves (PPE) — Bulk Pack', 'category' => 'Safety & PPE', 'unit' => 'BOX',
        ...
        SkuMaster::create([
            'sku' => 'PCM Raw Compound (TN+29 Grade)', 'category' => 'PCM — Trial', 'unit' => 'KG',
    ...
    {
        VendorMaster::create([
            'vendor_name' => 'Thermocore Materials Pvt Ltd', 'gst_number' => '27AACCH1234K1Z5',
        ...
        VendorMaster::create([
            'vendor_name' => 'Konkan Insulation Systems', 'gst_number' => '27AAFCK5566L1Z2',
        ...
        VendorMaster::create([
            'vendor_name' => 'Sagar Safety & Industrial Supplies', 'gst_number' => '27AADCS7788M1Z9',
        ...
        VendorMaster::create([
            'vendor_name' => 'Trial Run Components', 'gst_number' => '27AAGCT9911N1Z4',
    ...
    private function seedPurchaseOrders(): void
    {
        $po1 = PurchaseOrder::create([
            'po_number' => 'PO RM 2627 0020', 'po_owner' => 'Priya Admin',
        ...
        $po1->lines()->create(['product' => 'PCM Raw Compound (TN-1 Grade)', 'quantity' => 700, 'list_price' => 42]);

        $po2 = PurchaseOrder::create([
            'po_number' => 'PO RM 2627 0031', 'po_owner' => 'Priya Admin',
        ...
        $po2->lines()->create(['product' => 'Wire Mesh — Structural Packaging', 'quantity' => 450, 'list_price' => 18]);

        $po3 = PurchaseOrder::create([
            'po_number' => 'PO RM 2627 0018', 'po_owner' => 'Priya Admin',
            'subject' => 'Raw material — Hand Gloves (PPE) — Bulk Pack',
            'vendor_name' => 'Sagar Safety & Industrial Supplies',
            'po_date' => '2026-06-22', 'due_date' => '2026-06-28', 'status' => 'Approved',
        ]);
        $po3->lines()->create(['product' => 'Hand Gloves (PPE) — Bulk Pack', 'quantity' => 300, 'list_price' => 26]);

        $po4 = PurchaseOrder::create([
            'po_number' => 'PO RM 2627 0045', 'po_owner' => 'Priya Admin',
        ...
        $po4->lines()->create(['product' => 'PCM Raw Compound (TN+29 Grade)', 'quantity' => 200, 'list_price' => 30]);

        // The client's own real test record from their Zoho CRM, kept as a
        // reference — not a fictional demo entry.
        $po5 = PurchaseOrder::create([
            'po_number' => '898897889', 'subject' => 'INQUIRY', 'requisition_number' => '86868689',
            'vendor_name' => 'Tasmiya', 'contact_name' => 'Ravinder B',
            'po_date' => '2026-07-07', 'due_date' => '2026-07-15', 'status' => 'Created', 'carrier' => 'FedEx',
        ]);
        $po5->lines()->create(['product' => 'Freight/Shipping Charges', 'quantity' => 1, 'list_price' => 1]);
    }
    ...
    private function seedGateEntriesAndDownstream(): void
    {
        ...
        $tcmGate = GateEntry::create([
            'gate_no' => 'GATE-1001', 'entry_type' => 'inward',
        ...
        $gate2 = GateEntry::create([
            'gate_no' => 'GATE-1014', 'entry_type' => 'inward',
        ...
        $gate3 = GateEntry::create([
            'gate_no' => 'GATE-1015', 'entry_type' => 'inward',
            'po_number' => 'PO RM 2627 0031', 'vendor_name' => 'Konkan Insulation Systems',
            'invoice_number' => 'KIS/INV/1187', 'invoice_qty' => 450, 'material' => 'Wire Mesh — Structural Packaging',
        ...
        $gate4 = GateEntry::create([
            'gate_no' => 'GATE-1009', 'entry_type' => 'inward',
        ...
        ValidationIssue::create(['gate_entry_id' => $gate2->id, 'code' => 'DUP_INVOICE', 'title' => 'Duplicate Invoice', 'description' => 'Possible duplicate invoice detected', 'severity' => 'hardFail', 'status' => 'open', 'created_at' => '2026-06-30 04:32:51']);
        ValidationIssue::create(['gate_entry_id' => $gate3->id, 'code' => 'DUP_INVOICE', 'title' => 'Duplicate Invoice', 'description' => 'Possible duplicate invoice detected', 'severity' => 'hardFail', 'status' => 'open', 'created_at' => '2026-06-30 04:21:38']);
        ValidationIssue::create(['gate_entry_id' => $gate4->id, 'code' => 'DUP_INVOICE', 'title' => 'Duplicate Invoice', 'description' => 'Possible duplicate invoice detected', 'severity' => 'hardFail', 'status' => 'open', 'created_at' => '2026-06-27 23:10:08']);

        VendorSubmission::create([
            'po_number' => 'PO RM 2627 0020', 'vendor_name' => 'Thermocore Materials Pvt Ltd',
            'invoice_number' => 'TCM/INV/4471', 'invoice_qty' => 700, 'material' => 'PCM Raw Compound (TN-1 Grade)',
        ...
        UnloadingRecord::create([
            'gate_entry_id' => $tcmGate->id, 'box_count' => 28, 'staging_area' => 'Staging Bay 3',
        ...
        LedgerEntry::create(['gate_entry_id' => $tcmGate->id, 'sku' => 'PCM Raw Compound (TN-1 Grade)', 'bin' => 'BHW-PCM-A1', 'bucket' => 'available', 'qty' => 690, 'created_at' => '2026-06-25 11:22:00']);
        LedgerEntry::create(['gate_entry_id' => $tcmGate->id, 'sku' => 'PCM Raw Compound (TN-1 Grade)', 'bin' => 'BHW-PCM-A1', 'bucket' => 'defective', 'qty' => 5, 'created_at' => '2026-06-25 11:22:00']);

        FinanceRecord::create([
            'gate_entry_id' => $tcmGate->id, 'vendor_name' => 'Thermocore Materials Pvt Ltd', 'invoice_number' => 'TCM/INV/4471',
    ...
    {
        VendorStockUpdate::create(['vendor_name' => 'Thermocore Materials Pvt Ltd', 'material' => 'PCM Raw Compound (TN-1 Grade)', 'quantity' => 850, 'unit' => 'KG', 'note' => 'Ready to dispatch against next PO', 'created_at' => '2026-07-02 10:15:00']);
        VendorStockUpdate::create(['vendor_name' => 'Thermocore Materials Pvt Ltd', 'material' => 'PCM Raw Compound (TN+29 Grade)', 'quantity' => 200, 'unit' => 'KG', 'created_at' => '2026-06-28 16:40:00']);
    }
}
