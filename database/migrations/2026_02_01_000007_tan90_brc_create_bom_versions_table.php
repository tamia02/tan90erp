...
return new class extends Migration
{
    ...
    {
        Schema::create('tan90_bom_versions', function (Blueprint $table) {
            $table->id();
            $table->foreignId('tan90_bom_id')->constrained('tan90_boms')->cascadeOnDelete();
            ...
            $table->unique(['tan90_bom_id', 'revision_code']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('tan90_bom_versions');
    }
};
