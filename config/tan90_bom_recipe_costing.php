...
return [
    ...
    'entities' => [
        ...
        'components' => [
            ...
            'code' => 'masking_code',
            'columns' => ['masking_code', 'type', 'uom', 'standard_cost', 'approval_status', 'status'],
            'searchable' => ['code', 'name', 'masking_code'],
            'critical_fields' => ['standard_cost', 'uom'],
            // Client requirement: the real chemical name (and the legacy
            // "code" abbreviation) must never be shown outside this create/
            // edit form - every other screen only ever shows masking_code.
            'hidden_summary_fields' => ['name', 'code'],
            'fields' => [
                ['name' => 'code', 'label' => 'Component Code (internal only)', 'type' => 'text', 'required' => true],
                ['name' => 'name', 'label' => 'Component Name (internal only)', 'type' => 'text', 'required' => true],
        ...
        'quality-specs' => [
            ...
            'code' => 'code',
            'columns' => ['code', 'parameter_name', 'finishedGood.name', 'component.masking_code', 'criticality', 'approval_status'],
            ...
            'fields' => [
                ...
                ['name' => 'tan90_component_id', 'label' => 'Component', 'type' => 'select', 'required' => false, 'relation' => ['model' => Component::class, 'label_field' => 'masking_code']],
        ...
        'alternate-components' => [
            ...
            'primary' => 'id',
            'code' => 'id',
            'columns' => ['component.masking_code', 'alternateComponent.masking_code', 'ratio', 'effective_from', 'effective_to', 'approval_status'],
            'searchable' => [],
            'critical_fields' => ['ratio'],
            'fields' => [
                ['name' => 'tan90_component_id', 'label' => 'Component', 'type' => 'select', 'required' => true, 'relation' => ['model' => Component::class, 'label_field' => 'masking_code']],
                ['name' => 'tan90_alternate_component_id', 'label' => 'Alternate Component', 'type' => 'select', 'required' => true, 'relation' => ['model' => Component::class, 'label_field' => 'masking_code']],
        ...
        'substitution-rules' => [
            ...
            'primary' => 'code',
            'code' => 'code',
            'columns' => ['code', 'component.masking_code', 'substituteComponent.masking_code', 'max_percentage', 'requires_approval', 'approval_status'],
            'searchable' => ['code'],
            'critical_fields' => ['max_percentage'],
            'fields' => [
                ['name' => 'code', 'label' => 'Rule Code', 'type' => 'text', 'required' => true],
                ['name' => 'tan90_component_id', 'label' => 'Component', 'type' => 'select', 'required' => true, 'relation' => ['model' => Component::class, 'label_field' => 'masking_code']],
                ['name' => 'tan90_substitute_component_id', 'label' => 'Substitute Component', 'type' => 'select', 'required' => true, 'relation' => ['model' => Component::class, 'label_field' => 'masking_code']],
